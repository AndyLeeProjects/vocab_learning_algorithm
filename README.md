...
Although there exists a PyDictionary module that allows direct retrieval of vocabularies, connecting to the Lingua Robot API provides a broader range of words and definitions. Also, the it generates vocab examples that will help with overall comprehension of the word. 
